<template> 
  <form class="form_container">
    ...
    <div class="title_container">
      ...
      <span class="subtitle">To get started, simply just create an account and enjoy the experience!</span>
    </div>
    <br>
    <div class="input_container">
      ...
      <input v-model="userEmail" placeholder="name@mail.com" type="text" class="input_field" id="email_field">
    </div>
    <div class="input_container">
      ...
      <input v-model="userPass" placeholder="Password" type="password" class="input_field" id="password_field">
    </div>
    <button @click="loginUser()" title="Sign In" type="submit" class="sign-in_btn">
      <span>Sign In</span>
    </button>
    ...
    <button title="Sign In" type="submit" class="sign-in_ggl">
    <i class="fab fa-google" style="font-size: 18px; margin-right: 10px;"></i>
    <span>Sign In with Google</span>
  </button>
  ...
  .form_container {
    ...
    background-image: url('https://tyra-parring.github.io/host-/image/bk.jpg');
